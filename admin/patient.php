...
// }
 ...
 ?>
            <section class="content-header">
                <h1 id="192168001" class="col-sm-8">
            <?php  echo $fname.' '.$lname; ?>  <small>  <?php //echo '   '.$description; 
            ?></small>
          </h1>
              <a href="#" id="viewAll_djrh3ki4" class="col-md-offset-1 col-sm-2 btn btn-default" style="margin-top: 26px;"> all patients</a>  


   <form name="photo" action="patient.php" method="post" enctype="multipart/form-data" id="patient_id_new" <?php if($idd!=0) { echo ' style="display:none;" ';} ?>
 >
           <input type="text" name="id" class="hidden" id="prescribe_this" value="<?php echo $idd; ?>"  />
                                      

<button  type="submit"  class="col-md-offset-1 col-sm-2 btn btn-success" style="margin-top: 15px; margin-bottom: 15px;"> detailed </button>
