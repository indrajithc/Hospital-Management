<?php include( 'header.php');  ?>
    ...
    <div class="content-wrapper show_hide" style="min-height: 300px;" id="add_medicine_category">
        ...
        <section class="content-header">
            <h1 style="margin-bottom: 40px;margin-left: 10px;">
           Medicine
                            ...
                            <form class="form-horizontal new_edited_t" role="form" id="add_medicine_c">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-9 col-sm-offset-5 col-sm-9">
                                        <button type="submit" class="btn btn-default btn-block to_uppercase" style="color: black;">ADD</button>
                                    </div>
                                </div>
                            </form>
                            <!-- /form -->
...
try {
  $query = "SELECT * FROM `medicine_category` ORDER BY date DESC";
    ...
    <div class=" container show_hide" id="view_medicine_category" style="min-height: 300px; display: none;">

        <section class="content-header" id="header_section_1">
            <h1 class="col-sm-10">
           Medicine
            <small style="font-size: 14px;">  medicine category</small> 
          </h1> 
 <a class="col-sm-2 btn btn-default"  id="back_to_add_medicine_category"  style="margin-top: 32px;" href="#"> back</a>
        </section>

        <section class="col-md-12 ">

            <div class="  pading_5 soneme_dv1" style="margin-bottom: 70px;">
                ...
                <div class=" pading_5 back_white">
                    ...
                    <table class="table table-bordered table-striped sortable miyazaki my_table_x4" id="the_display_table_2">
                        ...
                        <tbody>
                            ...
                            <?php  
try {
  $query = "SELECT m.id AS id , c.name AS category, m.name AS name , m.description , m.delete_status AS delete_status, m.image AS image, m.type AS type, m.unit_price AS price, m.status AS status, m.delete_status FROM `medicines` m LEFT JOIN `medicine_category` c ON m.medicine_category_id = c.id  ORDER BY m.date DESC";
                 if( $result = $a->display($query)) {
