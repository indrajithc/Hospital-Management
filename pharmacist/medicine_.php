...
?>
    ...
    <!-- add Medicine -->
    <div class="content show_hide" style="margin: 5px 25px 5px 25px;" id="add_medicine_category" did="<?php  ?>">

        <!--=================================================edit med====================================================- -->



        <div  class="col-md-12 content-header" id="header_section_2">
            <h1>
           <?php echo $name; ?>
                ...
                <div class="pading_5 back_white">
                    ...
                    <div class="row pading_5">
                        ...
                        <form role="form" id="vView_medicine">
                            ...
                            <div class="col-md-offset-1 col-md-5 jzt_margin_bott">
